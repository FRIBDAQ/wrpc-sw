...
#define SPLL_DBG_EVT_SWEEP_START 6		/* Start of sweep */
#define SPLL_DBG_EVT_SWEEP_DONE 7		/* End of sweep */
#define SPLL_DBG_EVT_T24P_CALIB 8		/* End of sweep */
#define SPLL_DBG_EVT_T24P_DONE 9		/* End of sweep */
